...
* enable workflows on fork, trigger initial GHCR build ([31e060a](https://github.com/LostUmbrella58/docker-multi-java/commit/31e060af474c0bc809fa8cc72c127c6adbd50c22))
* fork to LostUmbrella58, publish to own GHCR namespace ([d354eb4](https://github.com/LostUmbrella58/docker-multi-java/commit/d354eb4cf9e4adc39f3ea0e94bee4453ed33f22c))
* 优化发布流程 - 避免重复构建，添加Docker镜像压缩包到Release ([0df0b6b](https://github.com/LostUmbrella58/docker-multi-java/commit/0df0b6b35e2510134c42c52602dfcdf180a33368))
* 更新README.md，添加Docker镜像拉取命令示例 ([def34f2](https://github.com/LostUmbrella58/docker-multi-java/commit/def34f25c628f800499e63c684da9e3d3b789439))
* 添加 Azul Zulu JDK 25 支持 ([1fa339f](https://github.com/LostUmbrella58/docker-multi-java/commit/1fa339f08aa15b29b53bdf87817d8a5c8e4b6498))


### 🐛 修复

* 修复GitHub Actions权限问题 ([535ba19](https://github.com/LostUmbrella58/docker-multi-java/commit/535ba19e4a59d796b4893c3308fba2237a817fad))
* 修复semantic-release输出变量导致Docker发布跳过的问题 ([5630794](https://github.com/LostUmbrella58/docker-multi-java/commit/56307946e08e7e1e57af523632bb009113cf6d86))
* 修复自动发布流程 ([51f2db9](https://github.com/LostUmbrella58/docker-multi-java/commit/51f2db94341884906eeeb7232fe64cb4c09cf9d3))
* 移除可能包含敏感信息的image-tags输出 ([66334db](https://github.com/LostUmbrella58/docker-multi-java/commit/66334db046c372dcd25bb5033c3dad6b091cc7f9))
